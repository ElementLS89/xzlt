...
class db_driver_mysql
{
	...
	function set_config($config,$serverid=1) {
		...
		$this->config = &$config;
		$this->tablepre = $config[$serverid]['pre'];
	}
	...
	function connect($serverid = 1) {
		...
		$this->link[$serverid] = $this->_dbconnect(
			$this->config[$serverid]['host'],
			$this->config[$serverid]['user'],
			$this->config[$serverid]['pw'],
			$this->config[$serverid]['charset'],
			$this->config[$serverid]['name'],
