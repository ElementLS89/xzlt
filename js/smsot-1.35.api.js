var smsot = {
	...
	editreply : function(upid,vid,pid,mod) {
		SMS.ajax('reply.php?vid='+vid+'&pid='+pid+'&mod='+mod+'&s=c&get=ajax','.currentbody #replycontent_'+pid,'replace');
		SMS.deleteitem('topic.php?vid='+vid);
	},
	addreply : function(s,vid,pid,upid,replys,modurl,mod) {
    
		if(s=='l'){
			SMS.ajax('reply.php?vid='+vid+'&pid='+pid+'&mod='+mod+'&get=ajax&s=l','.currentbody #replylist');
			...
			SMS.ajax('reply.php?vid='+vid+'&pid='+pid+'&mod='+mod+'&get=ajax&s=n','.currentbody #comments_'+upid,'prepend');
