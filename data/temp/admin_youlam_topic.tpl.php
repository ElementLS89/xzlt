...
<div class="block" id="youlam_topic_types">
<h3>选择话题分栏</h3>
<ul class="catalog cl">
  <li<?php if($_GET['ac']!='add') { ?> class="a"<?php } ?>><a href="admin.php?mod=<?php echo $_GET['mod'];?>&item=<?php echo $_GET['item'];?>&iframe=yes">我是aaa</a></li>
  <li<?php if($_GET['ac']=='add') { ?> class="a"<?php } ?>><a href="admin.php?mod=<?php echo $_GET['mod'];?>&item=<?php echo $_GET['item'];?>&iframe=yes">我是bbb</a></li>
</ul>
</div>

<div id="youlam_topic_tips_list"></div>
