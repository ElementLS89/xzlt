...
<div class="block">
  ...
  <form action="admin.php?mod=<?php echo $_GET['mod'];?>&item=<?php echo $_GET['item'];?>" method="post">
    ...
    <table class="table" cellpadding="0" cellspacing="0">
      <tr>
        <th>站点关键词</th>
        <td><input type="text" class="input w300" name="keywords" value="<?php echo $_S['setting']['keywords'];?>"><em>设置网站的关键词，多个用逗号隔开</em></td>
      </tr>
      <tr>
        <th>站点描述</th>
        <td><textarea class="textarea" name="description"><?php echo $_S['setting']['description'];?></textarea></td>
      </tr>
      <tfoot>
        <tr>
          <td colspan="2">
